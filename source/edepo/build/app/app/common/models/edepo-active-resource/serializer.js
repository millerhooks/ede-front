 ...
 */
angular.module('edepo.models.active-resource.serializer', [
    'ActiveResource'
]).provider('EdepoSerializer', function() {
    this.$get = [
        'json',
        'ARMixin',
        'ARAssociations',
        ...
        'ARDeferred',
        'ARSerializer',
        function(json, mixin, Associations, Helpers, deferred, ARSerializer) {
            function Serializer() {
                //this.inherits = function (base) {
                //    var _constructor;
                //    _constructor = this;
                ...
                this.deserialize = function(httpResponse, instance, options) {
                    console.log('Custom Deserializer');
                    var json, options;
            ...
            ;
            //
            //Serializer.inherits(ARSerializer);
            return Serializer;
        }
    ];
});